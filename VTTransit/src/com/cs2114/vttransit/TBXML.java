...
/**
 * TBXML for Java Transcription from excellent XML parser TBXML from TOM
 * BRADLEY.
 * 
 * NOTE THAT THIS CLASS IS A THIRD PARTY CLASS NOT WRITTEN BY THE AUTHORS OF
 * THIS ANDROID PROJECT AND IS NOT UNDER TEST. THERE IS PLENTY OF DOCUMENTATION
 * ONLINE TO SUPPORT THAT THIS CLASS IS EXTREMELY USEFUL AND WORKS CORRECTLY.
 * 
 * @author julien.foltz (Julien Foltz, originally from Tom Bradley)
 */
public class TBXML {
